...
func (suite *ControllerTestSuite) SetupTest() {
	...
	suite.lcmCtl.On("Track", suite.jobID).Return(job.NewBasicTrackerWithStats(suite.res, nil, "ns", nil, nil), nil)
	suite.lcmCtl.On("New", suite.res).Return(job.NewBasicTrackerWithStats(suite.res, nil, "ns", nil, nil), nil)
